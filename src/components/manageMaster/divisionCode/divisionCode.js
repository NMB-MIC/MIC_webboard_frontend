...
class divisionCode extends Component {
  componentDidMount() {
    ...
    document.title = APP_TITLE + " manage_divisionCode";
              ...
              <button
                onClick={() =>
                  this.props.history.push(
                    `/edit_divisionCode/${item.divisionCode}`
                  )
                }
                type="button"
              ...
              <button
                onClick={() => {
                  MySwal.fire({
                    ...
                    if (result.value) {
                      this.props.deleteDivision(item.divisionCode);
                    }
                  });
                }}
                type="button"
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-header">
                    <h2 className="card-title">division code table</h2>
                  </div>
                  {/* /.card-header */}
...
export default connect(mapStateToProps, mapDispatchToProps)(divisionCode);
