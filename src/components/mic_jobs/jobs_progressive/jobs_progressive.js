...
class Jobs_progressive extends Component {
  ...
  doGetJobs = async () => {
    let result = await httpClient.get(server.MIC_JOB_URL + '/onGoing')
  ...
  loadingScreen() {
    if (this.state.data == null && !(this.state.isLoadSuccess)) {
      ...
      return <div>No any on going jobs...</div>
    }
  }
          ...
          <div className="container-fluid">
            <div className="row mb-2">
              <div className="col-sm-6" style={{ textAlign: "left" }}>
                <h1 class="m-0 text-dark">Jobs progressive</h1>
              </div>
...
export default Jobs_progressive;
